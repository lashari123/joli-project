    ...
    const brochure = this.state.brochure.map((item, index) => {
      return (
        ...
        <tr key={index} className="outerTable">
          ...
          <td className="text">{item.OrderPaymentNo}</td>
          <td className="text">{item.amount}</td>
          <td className="text">{item.receiptNo}</td>
          <td className="text">{item.encoder}</td>
          <td>
      ...
      <tr>
       ...
       {/* <Pagination/> */}
        ...
        /> */}
         ...
         <ProofPagination  
          button={   <button style={{width:'131px', padding:'6px 10px', fontSize:'16px', marginLeft:'15px'}}>Add</button>}/>
          </div> 
      </div>
    );
  }
